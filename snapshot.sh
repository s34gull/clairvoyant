...
# ----------------------------------------------------------------------
# This needs to be a lot more fault tolerant, but the idea is to create a 
# rotating snapshot of the contents of $INCLUDES whenever called (minus the 
# contents of the .exlude files). Snapshots are written to a specified sparse 
# disk image hosted file system (via loopback) for portability. If the
# filesystem on the disk image supports it, space is preserved via hardlinks.
# ----------------------------------------------------------------------
